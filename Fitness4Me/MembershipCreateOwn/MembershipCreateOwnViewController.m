//
//  MembershipCreateOwnViewController.m
//  Fitness4Me
//
...
@interface MembershipCreateOwnViewController ()

@end

@implementation MembershipCreateOwnViewController
...
- (IBAction)onClickTellMeMore:(id)sender {
    MembershipPersonalViewController *viewController;
    
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone)
    {
        
        viewController = [[MembershipPersonalViewController alloc]initWithNibName:@"MembershipPersonalViewController" bundle:nil];
